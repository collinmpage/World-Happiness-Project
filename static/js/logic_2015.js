...
var geoData = "static/json_2015.geojson";
...
d3.json(geoData).then(function(data) {
  ...
  geojson = L.choropleth(data, {
    ...
    onEachFeature: function(feature, layer) {
      layer.bindPopup('<b>Country Name: </b>' + feature.properties.name + "<br><b>Overall Rank 2015: </b>" + feature.properties.overall_rank + "<br><b>Happiness Score 2015: </b><br>" +
